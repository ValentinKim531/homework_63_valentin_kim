...
class CustomUserCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {'username': 'логин', 'password': 'пароль', 'password_confirm': 'подтверждение пароля', 'first_name': 'Имя', 'last_name': 'Фамилия', 'email': 'Email', 'avatar': 'Аватар',
...
class UserChangeForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'first_name': 'Имя', 'last_name': 'Фамилия', 'email': 'Email', 'avatar': 'Аватар', 'birth_date': 'Дата рождения'}
